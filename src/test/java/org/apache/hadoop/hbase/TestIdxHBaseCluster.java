    ...
    public void testConcurrentReadWrite() throws IOException {
        ...
        while (count < finalCount) {
            ...
            if (!condition) {
                ...
                // Useful debugging harness.
                //System.out.println("DEBUGPRINT:");
                //DebugPrint.dumpToFile("/tmp/debug.txt");
                //System.out.println(DebugPrint.out.toString());
                //System.out.println("----- MY RESULT");
                //for ( Result r : resultList ) System.out.println(r);
                //System.out.println("---- PREV RESULTZ: " );
                //for ( Result r : prevList ) System.out.println(r);
            }
